          ...
          <div className="settings-main">
            {activeTab === 'privacy' && (
              <div className="settings-content scrollable">
                ...
                <p>Welcome to **ThinkChain AI**. Your privacy is paramount to us. This policy describes how we handle your data.</p>
            ...
            {activeTab === 'terms' && (
              <div className="settings-content scrollable">
                ...
                <p>By using **ThinkChain AI**, you agree to the following terms:</p>
                ...
                <p>ThinkChain AI provides information based on search results. We do not guarantee the absolute accuracy of external sources.</p>
 
                <h4 className="settings-subheading">3. Intellectual Property</h4>
                <p>The ThinkChain AI branding and search algorithms are the property of the developers.</p>
              </div>
            )}
 
            {activeTab === 'about' && (
              <div className="settings-content scrollable">
                <h3 className="settings-heading">About ThinkChain AI</h3>
                <p><strong>Version: 2.0 (Premium)</strong></p>
                <p>ThinkChain AI is a cutting-edge research assistant designed to synthesize complex information into clear, actionable answers.</p>
                <p>© 2026 ThinkChain AI Research Lab. All rights reserved.</p>
              </div>
            )}
          </div>
        </div>
